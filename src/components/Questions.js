          ...
          <div className="font-weight-bold">
            <div className="menu" id="menu">
              ...
              <a href="#"className="d-block p-3"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-person-circle mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                </svg><Link to="/Bakeliste">Bakeliste</Link></a>
            </div>
          </div>
          ...
          <div className="row ">
            <div className="col-lg-12 mt-4">
              <a className="text-bold ml-4" id="text-le"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-card-list mr-2"  xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="card rounded-lg border-lightgray">
                  <div className="card-body">
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          <th scope="row"><h4>Question</h4>
                          <p>Vous cherchez un peu plus de lesquels vous souhaitez
                             être informé par référentiel.</p>
                          </th>
                          <td>
                            <svg width="2.5em" height="2.5em" viewBox="0 0 16 16" className="bi bi-x" id="false" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                            </svg>
                        </td>
                        <td><span className="timing text-danger">20s</span></td>
                        </tr>
                        <tr>
                          <th scope="row"><h4>Question</h4>
                          <p>Vous cherchez un peu plus de lesquels vous souhaitez
                        ...
                        <tr>
                          ...
                          <td><svg width="2.5em" height="2.5em" viewBox="0 0 16 16" className="bi bi-check" id="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
