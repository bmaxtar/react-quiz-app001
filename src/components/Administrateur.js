                  ...
                  <ul className="navbar-nav ml-auto">
                    <li className="nav-item">
                      ...
                      <li className="nav-item active">
                          <a className="nav-link" href="#">Administrateur<i><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-chevron-down mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="container mt-4 ml-2">
          <div className="row ">
            <div className="col-lg-12 mt-4">
              <a className="text-bold ml-4" id="text-le"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-people-fill mr-4"  xmlns="http://www.w3.org/2000/svg">
